...
const MASTER_NEWS: Record<string, any[]> = {
  "warren-buffett": [
    {
      id: 1,
      title: "버핏, 애플 지분 추가 매도...현금 보유량 사상 최대",
      date: "2026-05-15",
      source: "Bloomberg",
      summary:
        "버크셔 해서웨이가 Q1 2026 13F에서 애플 지분을 12.4% 추가 매도한 것으로 확인됐다.",
    },
    {
      id: 2,
      title: "버핏 주주 연례 미팅: AI는 도구, 수익력이 핵심",
      date: "2026-05-04",
      source: "CNBC",
      summary:
        "워런 버핏은 오마하 주주 연례 미팅에서 AI 기술에 대한 견해를 밝히며 기업의 수익력을 강조했다.",
    },
    {
      id: 3,
      title: "버크셔 Q1 순이익 $125억...운영 수익 사상 최고",
      date: "2026-04-28",
      source: "Reuters",
      summary: "버크셔 해서웨이의 Q1 2026 운영 수익이 사상 최고치를 기록했다.",
    },
  ],
  "ray-dalio": [
    {
      id: 1,
      title: "달리오, 미국 부채 위기 경고...달러 패권 약화 가능성",
      date: "2026-05-10",
      source: "LinkedIn",
      summary:
        "레이 달리오가 링크드인 포스팅을 통해 미국의 부채 수준이 역사적 임계점에 근접했다고 경고했다.",
    },
    {
      id: 2,
      title: "브리지워터, 신흥국 ETF 비중 확대...달러 약세 대응",
      date: "2026-02-20",
      source: "FT",
      summary:
        "브리지워터 어소시에이츠가 Q4 2025 13F에서 신흥국 ETF 비중을 확대한 것으로 나타났다.",
    },
  ],
  "michael-burry": [
    {
      id: 1,
      title: "버리, 중국 기술주 추가 매수...JD.com PER 6배 주목",
      date: "2026-05-12",
      source: "X(Twitter)",
      summary:
        "마이클 버리가 X 포스팅을 통해 중국 기술주의 극단적 저평가를 언급하며 추가 매수 의사를 밝혔다.",
    },
    {
      id: 2,
      title: "사이온 Q4 2025 13F: 알리바바 신규 편입, JD.com 비중 확대",
      date: "2026-02-14",
      source: "SEC",
      summary:
        "마이클 버리의 사이온 자산운용이 알리바바를 신규 편입하고 JD.com 비중을 확대했다.",
    },
  ],
  "cathie-wood": [
    {
      id: 1,
      title: "캐시 우드, AI 혁명 2단계 시작...ARK 수혜주 비중 확대",
      date: "2026-05-08",
      source: "CNBC",
      summary:
        "캐시 우드가 CNBC 인터뷰에서 AI 추론 비용 급감으로 기업 도입이 가속화되고 있다고 밝혔다.",
    },
    {
      id: 2,
      title: "ARK, UiPath 신규 편입...Zoom 완전 매도",
      date: "2026-02-14",
      source: "ARK Invest",
      summary:
        "ARK 인베스트가 Q4 2025 13F에서 UiPath를 신규 편입하고 Zoom을 완전 매도했다.",
    },
  ],
};
              ...
              <button
                onClick={() => {
                  if (isBookmarked) {
                    ...
                    bookmarkCtx?.addBookmark("master", master.id, {
                      title: master.nameKo,
                      subtitle: master.fund,
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {[
                    {
                      label: "YTD 수익률",
                      value: `${master.returnYtd >= 0 ? "+" : ""}${master.returnYtd}%`,
                      color:
                        master.returnYtd >= 0
                          ? "text-emerald-400"
                          : "text-red-400",
                    ...
                    {
                      label: "5년 수익률",
                      value: `${master.return5y >= 0 ? "+" : ""}${master.return5y}%`,
                      color:
                        master.return5y >= 0
                          ? "text-emerald-400"
                          : "text-red-400",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-card border border-border/50 rounded-xl p-5">
                    ...
                    <div className="mb-3">
                      <Badge
                        variant="outline"
                        className="text-xs bg-violet-500/10 text-violet-400 border-violet-500/30 mb-2"
                      >
                        {master.strategy}
                      </Badge>
                      {strategyDetail && (
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {sectors.map((s: string) => (
                          <Badge
                            key={s}
                            variant="outline"
                            className="text-[10px] px-2 py-0.5 bg-blue-500/10 text-blue-400 border-blue-500/30"
                          >
                            {s}
                          </Badge>
                        ))}
                  ...
                  <div className="bg-card border border-border/50 rounded-xl p-5">
                    ...
                    <div className="space-y-3">
                      {updates.map((u: any, i: number) => (
                        ...
                        >
                          <span
                            className={`text-[10px] px-1.5 py-0.5 rounded border flex-shrink-0 mt-0.5 ${UPDATE_TYPE_COLORS[u.type] || "bg-muted/50 text-muted-foreground border-border"}`}
                          >
                            {u.type}
                          </span>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between mb-1">
                                ...
                                <div className="flex items-center gap-1.5">
                                  <ChangeIcon
                                    className={`w-3 h-3 ${CHANGE_COLORS[h.change]}`}
                                  />
                                  <span
                                    className={`text-[10px] ${CHANGE_COLORS[h.change]}`}
                                  >
                ...
                <div className="bg-card border border-border/50 rounded-xl p-5">
                  ...
                  <div className="space-y-4">
                    {master.philosophy.map((p, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-4 p-4 bg-muted/20 rounded-xl border border-border/30"
                      >
                ...
                <div className="bg-card border border-border/50 rounded-xl p-5">
                  ...
                  <div className="grid grid-cols-4 gap-3 mb-5">
                    {[
                      {
                        label: "신규 편입",
                        count: master.topHoldings.filter(
                          (h) => h.change === "new",
                        ).length,
                        color: "text-blue-400",
                        bg: "bg-blue-500/10",
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="py-2.5 text-right">
                                <div
                                  className={`flex items-center justify-end gap-1 ${CHANGE_COLORS[h.change]}`}
                                >
                ...
                {news.length === 0 ? (
                  ...
                  news.map((item, i) => (
                    <motion.div
                      ...
                      onClick={() =>
                        toast.info(`${item.source}: ${item.title}`)
                      }
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <h4 className="text-sm font-semibold mb-1 hover:text-emerald-400 transition-colors">
                            {item.title}
                          </h4>
                          <p className="text-xs text-muted-foreground leading-relaxed">
                            {item.summary}
